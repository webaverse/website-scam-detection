...
const whitelistUrls = ['webaverse.com', 'metadrop.com', 'metadrops.com', 'metadrop.net'];
...
const urlsTocheckString = urlsToCheck.join('\n');

// convert urlsThatExist to a buffer
const urlsToCheckBuffer = Buffer.from(urlsTocheckString);

// write urls that exist to the urls file
fs.writeFile('urls_to_check.txt', urlsToCheckBuffer, (err) => {
    if (err) throw err;
...
console.log('urls exists:', urlsThatExist);